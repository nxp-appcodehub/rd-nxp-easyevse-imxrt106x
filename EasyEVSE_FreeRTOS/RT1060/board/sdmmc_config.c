...
#if ((MIMXRT1060_REVA == 0) && (MIMXRT1060_REVB == 0) && (MIMXRT1060_REVC == 0))
#error "Must specify one RT1060 revision!"
#endif

#if (((MIMXRT1060_REVA == MIMXRT1060_REVB) && (MIMXRT1060_REVA == 1)) || ((MIMXRT1060_REVA == MIMXRT1060_REVC) && (MIMXRT1060_REVA == 1)) || ((MIMXRT1060_REVB == MIMXRT1060_REVC) && (MIMXRT1060_REVB == 1)))
#error "Can't have more than one board revision enabled at a time."
#endif

#if MIMXRT1060_REVA
#define ENABLE  1
#define DISABLE 0
#elif MIMXRT1060_REVB
#define ENABLE  0
#define DISABLE 1
#elif MIMXRT1060_REVC
#define ENABLE  0
#define DISABLE 1
#endif
...
void BOARD_SDCardPowerControl(bool enable)
{
    if (enable)
    {
        HAL_GpioSetOutput(s_PowerResetGpioHandle, ENABLE);
    }
    else
    {
        HAL_GpioSetOutput(s_PowerResetGpioHandle, DISABLE);
    }
}
