...
public:
    ...
    ///
    virtual const std::vector<int32_t>& get_network_connection_slots() const = 0;
...
private:
    ...
    FreeRTOSSteadyTimer websocket_timer;
...
public:
    ...
    const std::vector<int32_t>& get_network_connection_slots() const override;
