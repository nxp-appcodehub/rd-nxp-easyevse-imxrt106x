...
private: // Members
    ...
    FreeRTOSSteadyTimer certificate_signed_timer;
    FreeRTOSSteadyTimer client_certificate_expiration_check_timer;
    FreeRTOSSteadyTimer v2g_certificate_expiration_check_timer;
