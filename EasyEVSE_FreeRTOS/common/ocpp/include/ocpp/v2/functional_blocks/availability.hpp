...
#else
    virtual void set_heartbeat_timer_interval(const uint32_t interval) = 0;
#endif
...
private: // Members
    ...
    FreeRTOSSteadyTimer heartbeat_timer;
...
#else
    void set_heartbeat_timer_interval(const uint32_t interval) override;
#endif
