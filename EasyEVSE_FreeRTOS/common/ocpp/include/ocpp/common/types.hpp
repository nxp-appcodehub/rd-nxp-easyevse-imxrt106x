...
class DateTimeImpl {
private:
    //std::chrono::time_point<date::utc_clock> timepoint; //11:59:59.500
    OcppTimepoint timepoint;
...
public:
    ...
    explicit DateTimeImpl(OcppTimepoint timepoint);
    ...
    OcppTimepoint to_time_point() const;

    //EVSE: return timestamp in seconds from 01.01.1970.
    unsigned long int to_time_point_s() const;
...
public:
    ...
    explicit DateTime(OcppTimepoint timepoint)
    {
    	;
    }
