...
protected:
    ...
    std::shared_ptr<FreeRTOSSteadyTimer> reconnect_timer;
    std::unique_ptr<FreeRTOSSteadyTimer> ping_timer;
...
#if EASYEVSE
    void log_on_fail(const std::error_code& ec, const int http_status);
#else
