...
#include "freertos_system_timer.hpp"
...
private:
    ...
    //EnhancedTransaction* transaction;                 // pointer to active transaction (can be nullptr)
    MeterValue meter_value;                           // represents current meter value
    FreeRTOSRecursiveMutex meter_value_mutex;
    FreeRTOSSteadyTimer sampled_meter_values_timer;
...
#endif
    std::unique_ptr<FreeRTOSSystemTimer> trigger_metervalue_at_time_timer;
//    FreeRTOSSystemTimer* trigger_metervalue_at_time_timer;
