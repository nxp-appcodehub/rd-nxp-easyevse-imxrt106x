...
{
    switch (e) {
    case NotifyCRLStatusEnum::Accepted:
        return "Accepted";
    case NotifyCRLStatusEnum::Rejected:
        return "Rejected";
    case NotifyCRLStatusEnum::Invalid:
        return "Invalid";
    }

    throw EnumToStringException{e, "NotifyCRLStatusEnum"};
}

NotifyCRLStatusEnum string_to_notify_crlstatus_enum(const std::string& s)
{
    if (s == "Accepted") {
        return NotifyCRLStatusEnum::Accepted;
    }
    if (s == "Rejected") {
        return NotifyCRLStatusEnum::Rejected;
    }
    if (s == "Invalid") {
        return NotifyCRLStatusEnum::Invalid;
    }

    throw StringToEnumException{s, "NotifyCRLStatusEnum"};
}
}
