...
j1772_status_t EVSE_J1772_SetCPFromState(j1772_state_t j1772_state, uint16_t amps)
{
    ...
    else if ((j1772_state == STATE_A2) || (j1772_state == STATE_B2) || (j1772_state == STATE_C2) ||
             (j1772_state == STATE_D2))
    {
    ...
    switch (j1772_simulation.current_state)
    {
        ...
        case STATE_D2:
        {
            ...
            else if (amps != 0)
            {
                ...
                {
                    j1772_simulation.ulLastCalcTime = EVSE_GetMsSinceBoot();
                    j1772_simulation.ev_data.currentCapacity +=
                        prvCalculateEnergy(amps, j1772_simulation.max_voltage, time_lapse);
                    ...
                    configPRINTF(
                        ("Current Battery Level: %.1f%",
                         j1772_simulation.ev_data.currentCapacity / (j1772_simulation.ev_data.fBatteryCapacity / 100)));
                }
            }
        }
        break;
        ...
        case STATE_D2:
        {
            ...
            if ((time_lapse >= BC_MEASURE_INTERVAL_MS) || (new_state == STATE_B) || (new_state == STATE_A))
            {
                ...
                j1772_simulation.evse_data.fMeterReading +=
                    prvCalculateEnergy(j1772_simulation.evse_data.fMeasuredCurrent,
                                       j1772_simulation.evse_data.fMeasuredVoltage, time_lapse);
            }
