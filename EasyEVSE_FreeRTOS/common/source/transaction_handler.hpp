...
struct TxStartStopConditions {
    ...
    bool is_stop_condition_fullfilled(const TxStartStopPoint tx_stop_point) {
        ...
        case TxStartStopPoint::PowerPathClosed:
            ...
            {
            	configPRINTF(("is_authorized true"));
            }
            else
            {
            	configPRINTF(("is_authorized false"));
            }

            if (is_ev_connected == true)
            {
            	configPRINTF(("is_ev_connected true"));
            }
            else
            {
            	configPRINTF(("is_ev_connected false"));
            }
