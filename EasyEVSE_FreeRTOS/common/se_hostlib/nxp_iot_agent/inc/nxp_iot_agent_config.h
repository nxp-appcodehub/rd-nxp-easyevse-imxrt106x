...
#define NXP_IOT_AGENT_MAX_NUM_ENDPOINTS        \
    ((size_t)(1U   /* agent itself */          \
              ...
              + NXP_IOT_AGENT_MAX_NUM_KEYSTORES + NXP_IOT_AGENT_MAX_NUM_DATASTORES))
 ...
 * is recommended.
 */
#define NXP_IOT_AGENT_VERIFY_EDGELOCK_2GO_SERVER_CERTIFICATE 1 // 1
...
#define NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERTIFICATES                                               \
    {                                                                                            \
        NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERT_RSA_PROD, NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERT_ECC_PROD \
    }
...
#define NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERTIFICATES_SIZE \
    NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERT_RSA_PROD_SIZE + NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERT_ECC_PROD_SIZE
#else
/* Test / Sandbox certificates */

#define NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERTIFICATES                                                     \
    {                                                                                                  \
        NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERT_RSA_SANDBOX, NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERT_ECC_SANDBOX \
    }

#define NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERTIFICATES_SIZE \
    NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERT_RSA_SANDBOX_SIZE + NXP_IOT_AGENT_TRUSTED_ROOT_CA_CERT_ECC_SANDBOX_SIZE
 ...
 */
#define IOT_AGENT_TIME_MEASUREMENT_ENABLE 0 // 1
