 ...
 *
 * @brief Session handling functions for the EdgeLock 2GO agent. When interacting with the OpenSSL engine, the agent
 * session needs to be closed before and opened after OpenSSL is active.
 *
 *
