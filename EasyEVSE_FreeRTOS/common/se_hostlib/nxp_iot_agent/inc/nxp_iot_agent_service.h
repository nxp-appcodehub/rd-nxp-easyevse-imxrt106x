 ...
 *
 * @brief Functionality to work with service descriptors. A service descriptor represents all information from a single
 * cloud provisioning.
 *
 */
 ...
 */
iot_agent_status_t iot_agent_service_get_service_type_as_string(const nxp_iot_ServiceDescriptor *service_descriptor,
                                                                const char **buffer);
 ...
 */
iot_agent_status_t iot_agent_service_get_service_offset_by_id(const iot_agent_datastore_t *ctx,
                                                              uint64_t service_id,
                                                              size_t *offset,
 ...
 * @see iot_agent_is_service_configuration_data_valid
 */
iot_agent_status_t iot_agent_service_get_service_offset_by_index(const iot_agent_datastore_t *datastore,
                                                                 size_t index,
                                                                 size_t *offset,
                                                                 nxp_iot_ServiceDescriptor *service_descriptor);
 ...
 * @see iot_agent_is_service_configuration_data_valid
 */
iot_agent_status_t iot_agent_service_get_service_descriptor_of_service(const iot_agent_datastore_t *datastore,
                                                                       size_t offset,
                                                                       nxp_iot_ServiceDescriptor *service_descriptor);
...
iot_agent_status_t iot_agent_service_read_buffer(const iot_agent_datastore_t *ctx,
                                                 size_t offset,
                                                 void *buffer,
                                                 size_t expected_len);
void iot_agent_service_read_header(const iot_agent_datastore_t *ctx,
                                   size_t offset,
                                   configuration_data_header_t *header);
#if SSS_HAVE_HOSTCRYPTO_OPENSSL
iot_agent_status_t iot_agent_service_calculate_cofiguration_checksum(const iot_agent_datastore_t *ctx,
                                                                     const configuration_data_header_t *header,
