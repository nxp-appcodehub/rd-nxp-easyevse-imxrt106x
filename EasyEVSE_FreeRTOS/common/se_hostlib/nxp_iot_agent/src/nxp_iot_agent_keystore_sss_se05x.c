...
#define IOT_AGENT_KEYSTORE_SSS_SE05x_VERSION                                                                     \
    (((IOT_AGENT_KEYSTORE_SSS_SE05x_VERSION_MAJOR * 256U) + IOT_AGENT_KEYSTORE_SSS_SE05x_VERSION_MINOR) * 256U + \
     IOT_AGENT_KEYSTORE_SSS_SE05x_VERSION_PATCH)
                                                     ...
                                                     bool is_session_open)
{
    ...
    iot_agent_keystore_sss_se05x_context_t *keystore_context = malloc(sizeof(iot_agent_keystore_sss_se05x_context_t));
...
bool iot_agent_keystore_sss_se05x_get_endpoint_info(void *context, void *endpoint_information)
{
    AX_UNUSED_ARG(context);
