...
#define _nxp_iot_ServiceDescriptorVersion_ARRAYSIZE \
    ((nxp_iot_ServiceDescriptorVersion)(nxp_iot_ServiceDescriptorVersion_PROTOBUF + 1))
...
#define _nxp_iot_AgentHelloRequest_DeviceState_ARRAYSIZE \
    ((nxp_iot_AgentHelloRequest_DeviceState)(nxp_iot_AgentHelloRequest_DeviceState_FORCE_UPDATE + 1))
...
#define _nxp_iot_AgentClaimStatus_ClaimStatus_ARRAYSIZE \
    ((nxp_iot_AgentClaimStatus_ClaimStatus)(nxp_iot_AgentClaimStatus_ClaimStatus_ERR_TIMEOUT + 1))
...
#define _nxp_iot_AgentRtpStatus_RtpStatus_ARRAYSIZE \
    ((nxp_iot_AgentRtpStatus_RtpStatus)(nxp_iot_AgentRtpStatus_RtpStatus_ERR_TIMEOUT + 1))
...
#define _nxp_iot_AgentCspStatus_CspStatus_ARRAYSIZE \
    ((nxp_iot_AgentCspStatus_CspStatus)(nxp_iot_AgentCspStatus_CspStatus_ERR_TIMEOUT + 1))
...
#define _nxp_iot_UpdateStatusReport_UpdateStatus_ARRAYSIZE \
    ((nxp_iot_UpdateStatusReport_UpdateStatus)(nxp_iot_UpdateStatusReport_UpdateStatus_ERR_TIMEOUT + 1))
...
#define nxp_iot_EndpointInformation_init_default                                                \
    {                                                                                           \
        false, _nxp_iot_EndpointType_MIN, false, 0, false, 0, false, 0, false, {0, {0}}, false, \
        {                                                                                       \
            0,                                                                                  \
            {                                                                                   \
                0                                                                               \
...
#define nxp_iot_AgentHelloRequest_init_default                                \
    {                                                                         \
        false, 0, false, _nxp_iot_AgentHelloRequest_DeviceState_MIN, false, 0 \
    }
#define nxp_iot_AgentHelloResponse_init_default                                                                \
    {                                                                                                          \
        false, 0, false, 1024, false, 1024, false, nxp_iot_ServiceDescriptorVersion_PROTOBUF, false, false, 0, \
        {                                                                                                      \
            nxp_iot_EndpointInformation_init_default, nxp_iot_EndpointInformation_init_default,                \
                nxp_iot_EndpointInformation_init_default, nxp_iot_EndpointInformation_init_default,            \
                nxp_iot_EndpointInformation_init_default                                                       \
        }                                                                                                      \
    }
#define nxp_iot_AgentAdditionalData_init_default                             \
    {                                                                        \
        false, nxp_iot_ServiceDescriptorVersion_PROTOBUF, false, 0, false, 0 \
    }
#define nxp_iot_AgentClaimStatus_init_default                     \
    {                                                             \
        false, _nxp_iot_AgentClaimStatus_ClaimStatus_MIN, 0, NULL \
    }
#define nxp_iot_AgentClaimStatus_DetailedClaimStatus_init_default  \
    {                                                              \
        false, _nxp_iot_AgentClaimStatus_ClaimStatus_MIN, false, 0 \
    }
#define nxp_iot_AgentRtpStatus_init_default                   \
    {                                                         \
        false, _nxp_iot_AgentRtpStatus_RtpStatus_MIN, 0, NULL \
    }
#define nxp_iot_AgentRtpStatus_RtpObjectStatus_init_default              \
    {                                                                    \
        false, _nxp_iot_AgentRtpStatus_RtpStatus_MIN, false, 0, false, 0 \
    }
#define nxp_iot_AgentCspStatus_init_default                   \
    {                                                         \
        false, _nxp_iot_AgentCspStatus_CspStatus_MIN, 0, NULL \
    }
#define nxp_iot_AgentCspStatus_CspServiceStatus_init_default             \
    {                                                                    \
        false, _nxp_iot_AgentCspStatus_CspStatus_MIN, false, 0, false, 0 \
    }
#define nxp_iot_UpdateStatusReport_init_default                                                                   \
    {                                                                                                             \
        false, _nxp_iot_UpdateStatusReport_UpdateStatus_MIN, false, nxp_iot_AgentClaimStatus_init_default, false, \
            nxp_iot_AgentRtpStatus_init_default, false, nxp_iot_AgentCspStatus_init_default, false, ""            \
    }
#define nxp_iot_AgentGoodbyeRequest_init_default       \
    {                                                  \
        false, nxp_iot_UpdateStatusReport_init_default \
    }
#define nxp_iot_AgentCrlRequest_init_default \
    {                                        \
        NULL                                 \
    }
#define nxp_iot_AgentCrlResponse_init_default \
    {                                         \
        false, 0                              \
    }
#define nxp_iot_EndpointInformation_init_zero                                                   \
    {                                                                                           \
        false, _nxp_iot_EndpointType_MIN, false, 0, false, 0, false, 0, false, {0, {0}}, false, \
        {                                                                                       \
            0,                                                                                  \
...
#define nxp_iot_AgentHelloRequest_init_zero                                   \
    {                                                                         \
        false, 0, false, _nxp_iot_AgentHelloRequest_DeviceState_MIN, false, 0 \
    }
#define nxp_iot_AgentHelloResponse_init_zero                                                     \
    {                                                                                            \
        false, 0, false, 0, false, 0, false, _nxp_iot_ServiceDescriptorVersion_MIN, false, 0, 0, \
        {                                                                                        \
            nxp_iot_EndpointInformation_init_zero, nxp_iot_EndpointInformation_init_zero,        \
                nxp_iot_EndpointInformation_init_zero, nxp_iot_EndpointInformation_init_zero,    \
                nxp_iot_EndpointInformation_init_zero                                            \
        }                                                                                        \
    }
#define nxp_iot_AgentAdditionalData_init_zero                            \
    {                                                                    \
        false, _nxp_iot_ServiceDescriptorVersion_MIN, false, 0, false, 0 \
    }
#define nxp_iot_AgentClaimStatus_init_zero                        \
    {                                                             \
        false, _nxp_iot_AgentClaimStatus_ClaimStatus_MIN, 0, NULL \
    }
#define nxp_iot_AgentClaimStatus_DetailedClaimStatus_init_zero     \
    {                                                              \
        false, _nxp_iot_AgentClaimStatus_ClaimStatus_MIN, false, 0 \
    }
#define nxp_iot_AgentRtpStatus_init_zero                      \
    {                                                         \
        false, _nxp_iot_AgentRtpStatus_RtpStatus_MIN, 0, NULL \
    }
#define nxp_iot_AgentRtpStatus_RtpObjectStatus_init_zero                 \
    {                                                                    \
        false, _nxp_iot_AgentRtpStatus_RtpStatus_MIN, false, 0, false, 0 \
    }
#define nxp_iot_AgentCspStatus_init_zero                      \
    {                                                         \
        false, _nxp_iot_AgentCspStatus_CspStatus_MIN, 0, NULL \
    }
#define nxp_iot_AgentCspStatus_CspServiceStatus_init_zero                \
    {                                                                    \
        false, _nxp_iot_AgentCspStatus_CspStatus_MIN, false, 0, false, 0 \
    }
#define nxp_iot_UpdateStatusReport_init_zero                                                                   \
    {                                                                                                          \
        false, _nxp_iot_UpdateStatusReport_UpdateStatus_MIN, false, nxp_iot_AgentClaimStatus_init_zero, false, \
            nxp_iot_AgentRtpStatus_init_zero, false, nxp_iot_AgentCspStatus_init_zero, false, ""               \
    }
#define nxp_iot_AgentGoodbyeRequest_init_zero       \
    {                                               \
        false, nxp_iot_UpdateStatusReport_init_zero \
    }
#define nxp_iot_AgentCrlRequest_init_zero \
    {                                     \
        NULL                              \
    }
#define nxp_iot_AgentCrlResponse_init_zero \
    {                                      \
        false, 0                           \
    }
