...
const pb_field_t nxp_iot_SssObjectReference_fields[4] = {
    ...
    PB_FIELD(3, UINT32, OPTIONAL, STATIC, OTHER, nxp_iot_SssObjectReference, object_id, endpoint_id, 0), PB_LAST_FIELD};
...
const pb_field_t nxp_iot_ServiceDescriptor_fields[20] = {
    ...
    PB_FIELD(50,
             ...
             &nxp_iot_SssObjectReference_fields),
    PB_FIELD(51,
             MESSAGE,
             OPTIONAL,
             STATIC,
    ...
    PB_FIELD(
        101, STRING, OPTIONAL, POINTER, OTHER, nxp_iot_ServiceDescriptor, azure_registration_id, azure_id_scope, 0),
    PB_FIELD(102,
             STRING,
             OPTIONAL,
             POINTER,
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(nxp_iot_ServiceDescriptor, client_certificate_sss_ref) < 65536 &&
                  pb_membersize(nxp_iot_ServiceDescriptor, server_certificate_sss_ref) < 65536 &&
                  pb_membersize(nxp_iot_ServiceDescriptor, client_key_sss_ref) < 65536),
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(nxp_iot_ServiceDescriptor, client_certificate_sss_ref) < 256 &&
                  pb_membersize(nxp_iot_ServiceDescriptor, server_certificate_sss_ref) < 256 &&
                  pb_membersize(nxp_iot_ServiceDescriptor, client_key_sss_ref) < 256),
                 YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_nxp_iot_SssObjectReference_nxp_iot_ServiceDescriptor)
#endif
