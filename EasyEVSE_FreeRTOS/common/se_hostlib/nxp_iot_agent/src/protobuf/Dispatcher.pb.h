...
#define nxp_iot_RequestPayload_init_default        \
    {                                              \
        0,                                         \
        {                                          \
            nxp_iot_AgentHelloRequest_init_default \
        }                                          \
    }
#define nxp_iot_ResponsePayload_init_default        \
    {                                               \
        0,                                          \
        {                                           \
            nxp_iot_AgentHelloResponse_init_default \
        }                                           \
    }
#define nxp_iot_EndpointRequest_init_default        \
    {                                               \
        false, _nxp_iot_EndpointType_MIN, false, 0, \
        {                                           \
            {NULL}, NULL                            \
        }                                           \
    }
#define nxp_iot_EndpointRequests_init_default \
    {                                         \
        {                                     \
            {NULL}, NULL                      \
        }                                     \
    }
#define nxp_iot_Requests_init_default \
    {                                 \
        {                             \
            {NULL}, NULL              \
        }                             \
    }
#define nxp_iot_Responses_init_default \
    {                                  \
        {                              \
            {NULL}, NULL               \
        }                              \
    }
#define nxp_iot_RequestPayload_init_zero        \
    {                                           \
        0,                                      \
        {                                       \
            nxp_iot_AgentHelloRequest_init_zero \
        }                                       \
    }
#define nxp_iot_ResponsePayload_init_zero        \
    {                                            \
        0,                                       \
        {                                        \
            nxp_iot_AgentHelloResponse_init_zero \
        }                                        \
    }
#define nxp_iot_EndpointRequest_init_zero           \
    {                                               \
        false, _nxp_iot_EndpointType_MIN, false, 0, \
        {                                           \
            {NULL}, NULL                            \
...
#define nxp_iot_EndpointRequests_init_zero \
    {                                      \
        {                                  \
            {NULL}, NULL                   \
        }                                  \
    }
#define nxp_iot_Requests_init_zero \
    {                              \
        {                          \
            {NULL}, NULL           \
        }                          \
    }
#define nxp_iot_Responses_init_zero \
    {                               \
        {                           \
            {NULL}, NULL            \
        }                           \
...
#define nxp_iot_RequestPayload_size                 \
    (5 + sizeof(union {                             \
         char f0[6279];                             \
         char f2[nxp_iot_AgentGoodbyeRequest_size]; \
         char f3[nxp_iot_AgentCrlRequest_size];     \
         char f20[nxp_iot_ApduRequest_size];        \
         char f30[nxp_iot_DatastoreRequest_size];   \
     }))
#define nxp_iot_ResponsePayload_size               \
    (5 + sizeof(union {                            \
         char f0[6279];                            \
         char f20[nxp_iot_ApduResponse_size];      \
         char f30[nxp_iot_DatastoreResponse_size]; \
     }))
