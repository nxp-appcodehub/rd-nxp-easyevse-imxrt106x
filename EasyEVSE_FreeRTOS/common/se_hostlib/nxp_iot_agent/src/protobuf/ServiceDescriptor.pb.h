...
#define nxp_iot_SssObjectReference_init_default              \
    {                                                        \
        false, _nxp_iot_EndpointType_MIN, false, 0, false, 0 \
    }
#define nxp_iot_ServiceDescriptor_init_default                                                                        \
    {                                                                                                                 \
        0, false, _nxp_iot_ServiceType_MIN, NULL, false, 0, false, 0, false, _nxp_iot_ServiceProtocolType_MIN, NULL,  \
            NULL, NULL, NULL, NULL, {{NULL}, NULL}, NULL, false, nxp_iot_SssObjectReference_init_default, false,      \
            nxp_iot_SssObjectReference_init_default, false, nxp_iot_SssObjectReference_init_default, NULL, NULL, NULL \
    }
#define nxp_iot_SssObjectReference_init_zero                 \
    {                                                        \
        false, _nxp_iot_EndpointType_MIN, false, 0, false, 0 \
    }
#define nxp_iot_ServiceDescriptor_init_zero                                                                          \
    {                                                                                                                \
        0, false, _nxp_iot_ServiceType_MIN, NULL, false, 0, false, 0, false, _nxp_iot_ServiceProtocolType_MIN, NULL, \
            NULL, NULL, NULL, NULL, {{NULL}, NULL}, NULL, false, nxp_iot_SssObjectReference_init_zero, false,        \
            nxp_iot_SssObjectReference_init_zero, false, nxp_iot_SssObjectReference_init_zero, NULL, NULL, NULL      \
    }
