...
#define _nxp_iot_DatastoreIdentifiers_ARRAYSIZE \
    ((nxp_iot_DatastoreIdentifiers)(nxp_iot_DatastoreIdentifiers_DATASTORE_EDGELOCK2GO_ID + 1))
...
#define nxp_iot_DatastoreAdditionalData_init_default \
    {                                                \
        false, 0                                     \
    }
#define nxp_iot_DatastoreRequest_init_default                       \
    {                                                               \
        false, _nxp_iot_DatastoreOperation_MIN, false, 0, false, 0, \
        {                                                           \
            {NULL}, NULL                                            \
        }                                                           \
    }
#define nxp_iot_DatastoreResponse_init_default         \
    {                                                  \
        false, _nxp_iot_DatastoreStatus_MIN, false, 0, \
        {                                              \
            {NULL}, NULL                               \
        }                                              \
    }
#define nxp_iot_DatastoreAdditionalData_init_zero \
    {                                             \
        false, 0                                  \
    }
#define nxp_iot_DatastoreRequest_init_zero                          \
    {                                                               \
        false, _nxp_iot_DatastoreOperation_MIN, false, 0, false, 0, \
        {                                                           \
            {NULL}, NULL                                            \
...
#define nxp_iot_DatastoreResponse_init_zero            \
    {                                                  \
        false, _nxp_iot_DatastoreStatus_MIN, false, 0, \
        {                                              \
            {NULL}, NULL                               \
