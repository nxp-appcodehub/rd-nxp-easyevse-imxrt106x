...
const nxp_iot_ServiceDescriptorVersion nxp_iot_AgentHelloResponse_serviceDescriptorVersion_default =
    nxp_iot_ServiceDescriptorVersion_PROTOBUF;
const nxp_iot_ServiceDescriptorVersion nxp_iot_AgentAdditionalData_serviceDescriptorVersion_default =
    nxp_iot_ServiceDescriptorVersion_PROTOBUF;
...
const pb_field_t nxp_iot_AgentHelloResponse_fields[7] = {
    ...
    PB_FIELD(2,
             ...
             communicationBufferSizeResponses,
             version,
             &nxp_iot_AgentHelloResponse_communicationBufferSizeResponses_default),
    PB_FIELD(3,
             INT32,
             OPTIONAL,
             STATIC,
             OTHER,
             nxp_iot_AgentHelloResponse,
             communicationBufferSizeRequests,
             communicationBufferSizeResponses,
             &nxp_iot_AgentHelloResponse_communicationBufferSizeRequests_default),
    PB_FIELD(4,
             UENUM,
             OPTIONAL,
             STATIC,
             OTHER,
             nxp_iot_AgentHelloResponse,
             serviceDescriptorVersion,
             communicationBufferSizeRequests,
             &nxp_iot_AgentHelloResponse_serviceDescriptorVersion_default),
    PB_FIELD(5,
             BOOL,
             OPTIONAL,
             STATIC,
             OTHER,
             nxp_iot_AgentHelloResponse,
             useMultipleRequestsPerMessage,
             serviceDescriptorVersion,
             &nxp_iot_AgentHelloResponse_useMultipleRequestsPerMessage_default),
    PB_FIELD(10,
             MESSAGE,
             REPEATED,
             STATIC,
             ...
             endpoints,
             useMultipleRequestsPerMessage,
             &nxp_iot_EndpointInformation_fields),
    PB_LAST_FIELD};
...
const pb_field_t nxp_iot_AgentAdditionalData_fields[4] = {
    PB_FIELD(1,
             ...
             serviceDescriptorVersion,
             serviceDescriptorVersion,
             &nxp_iot_AgentAdditionalData_serviceDescriptorVersion_default),
...
const pb_field_t nxp_iot_AgentClaimStatus_fields[3] = {
    ...
    PB_FIELD(2,
             ...
             details,
             status,
             &nxp_iot_AgentClaimStatus_DetailedClaimStatus_fields),
    PB_LAST_FIELD};
...
const pb_field_t nxp_iot_AgentRtpStatus_fields[3] = {
    ...
    PB_FIELD(2,
             ...
             details,
             status,
             &nxp_iot_AgentRtpStatus_RtpObjectStatus_fields),
    PB_LAST_FIELD};
...
const pb_field_t nxp_iot_AgentCspStatus_fields[3] = {
    ...
    PB_FIELD(2,
             ...
             details,
             status,
             &nxp_iot_AgentCspStatus_CspServiceStatus_fields),
    PB_LAST_FIELD};
...
const pb_field_t nxp_iot_UpdateStatusReport_fields[6] = {
    ...
    PB_FIELD(2,
             ...
             claimStatus,
             status,
             &nxp_iot_AgentClaimStatus_fields),
    PB_FIELD(3,
             MESSAGE,
             OPTIONAL,
             STATIC,
    ...
    PB_FIELD(4,
             ...
             cspStatus,
             rtpStatus,
             &nxp_iot_AgentCspStatus_fields),
    PB_FIELD(5, STRING, OPTIONAL, STATIC, OTHER, nxp_iot_UpdateStatusReport, correlationId, cspStatus, 0),
    PB_LAST_FIELD};

const pb_field_t nxp_iot_AgentGoodbyeRequest_fields[2] = {PB_FIELD(1,
                                                                   MESSAGE,
                                                                   OPTIONAL,
                                                                   STATIC,
                                                                   FIRST,
                                                                   ...
                                                                   status,
                                                                   status,
                                                                   &nxp_iot_UpdateStatusReport_fields),
                                                          PB_LAST_FIELD};

const pb_field_t nxp_iot_AgentCrlRequest_fields[2] = {
    PB_FIELD(1, BYTES, OPTIONAL, POINTER, FIRST, nxp_iot_AgentCrlRequest, crl, crl, 0), PB_LAST_FIELD};

const pb_field_t nxp_iot_AgentCrlResponse_fields[2] = {
    PB_FIELD(1, FIXED32, OPTIONAL, STATIC, FIRST, nxp_iot_AgentCrlResponse, error, error, 0), PB_LAST_FIELD};
 ...
 */
PB_STATIC_ASSERT(
    (pb_membersize(nxp_iot_AgentHelloResponse, endpoints[0]) < 65536 &&
     pb_membersize(nxp_iot_UpdateStatusReport, claimStatus) < 65536 &&
     pb_membersize(nxp_iot_UpdateStatusReport, rtpStatus) < 65536 &&
     pb_membersize(nxp_iot_UpdateStatusReport, cspStatus) < 65536 &&
     pb_membersize(nxp_iot_AgentGoodbyeRequest, status) < 65536),
    YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_nxp_iot_EndpointInformation_nxp_iot_AgentHelloRequest_nxp_iot_AgentHelloResponse_nxp_iot_AgentAdditionalData_nxp_iot_AgentClaimStatus_nxp_iot_AgentClaimStatus_DetailedClaimStatus_nxp_iot_AgentRtpStatus_nxp_iot_AgentRtpStatus_RtpObjectStatus_nxp_iot_AgentCspStatus_nxp_iot_AgentCspStatus_CspServiceStatus_nxp_iot_UpdateStatusReport_nxp_iot_AgentGoodbyeRequest_nxp_iot_AgentCrlRequest_nxp_iot_AgentCrlResponse)
#endif
 ...
 */
PB_STATIC_ASSERT(
    (pb_membersize(nxp_iot_AgentHelloResponse, endpoints[0]) < 256 &&
     pb_membersize(nxp_iot_UpdateStatusReport, claimStatus) < 256 &&
     pb_membersize(nxp_iot_UpdateStatusReport, rtpStatus) < 256 &&
     pb_membersize(nxp_iot_UpdateStatusReport, cspStatus) < 256 &&
     pb_membersize(nxp_iot_AgentGoodbyeRequest, status) < 256),
    YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_nxp_iot_EndpointInformation_nxp_iot_AgentHelloRequest_nxp_iot_AgentHelloResponse_nxp_iot_AgentAdditionalData_nxp_iot_AgentClaimStatus_nxp_iot_AgentClaimStatus_DetailedClaimStatus_nxp_iot_AgentRtpStatus_nxp_iot_AgentRtpStatus_RtpObjectStatus_nxp_iot_AgentCspStatus_nxp_iot_AgentCspStatus_CspServiceStatus_nxp_iot_UpdateStatusReport_nxp_iot_AgentGoodbyeRequest_nxp_iot_AgentCrlRequest_nxp_iot_AgentCrlResponse)
#endif
