...
#define nxp_iot_ApduRequest_init_default \
    {                                    \
        {{NULL}, NULL},                  \
        {                                \
            {NULL}, NULL                 \
...
#define nxp_iot_ApduResponse_init_default \
    {                                     \
        {                                 \
            {NULL}, NULL                  \
        }                                 \
    }
#define nxp_iot_ApduRequest_init_zero \
    {                                 \
        {{NULL}, NULL},               \
        {                             \
            {NULL}, NULL              \
...
#define nxp_iot_ApduResponse_init_zero \
    {                                  \
        {                              \
            {NULL}, NULL               \
        }                              \
