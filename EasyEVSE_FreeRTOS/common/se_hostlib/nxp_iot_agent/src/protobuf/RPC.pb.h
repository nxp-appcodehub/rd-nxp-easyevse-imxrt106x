...
#define nxp_iot_ArgumentPayload_init_default \
    {                                        \
        0,                                   \
        {                                    \
            0                                \
...
#define nxp_iot_Argument_init_default                         \
    {                                                         \
        false, 0, false, nxp_iot_ArgumentPayload_init_default \
    }
#define nxp_iot_RpcRequest_init_default                                                                     \
    {                                                                                                       \
        false, 0, 0,                                                                                        \
        {                                                                                                   \
            nxp_iot_Argument_init_default, nxp_iot_Argument_init_default, nxp_iot_Argument_init_default,    \
                nxp_iot_Argument_init_default, nxp_iot_Argument_init_default, nxp_iot_Argument_init_default \
        }                                                                                                   \
    }
#define nxp_iot_RpcResponse_init_default                                                                    \
    {                                                                                                       \
        false, 0, 0,                                                                                        \
        {                                                                                                   \
            nxp_iot_Argument_init_default, nxp_iot_Argument_init_default, nxp_iot_Argument_init_default,    \
...
#define nxp_iot_ArgumentPayload_init_zero \
    {                                     \
        0,                                \
        {                                 \
            0                             \
...
#define nxp_iot_Argument_init_zero                         \
    {                                                      \
        false, 0, false, nxp_iot_ArgumentPayload_init_zero \
    }
#define nxp_iot_RpcRequest_init_zero                                                               \
    {                                                                                              \
        false, 0, 0,                                                                               \
        {                                                                                          \
            nxp_iot_Argument_init_zero, nxp_iot_Argument_init_zero, nxp_iot_Argument_init_zero,    \
                nxp_iot_Argument_init_zero, nxp_iot_Argument_init_zero, nxp_iot_Argument_init_zero \
        }                                                                                          \
    }
#define nxp_iot_RpcResponse_init_zero                                                              \
    {                                                                                              \
        false, 0, 0,                                                                               \
        {                                                                                          \
            nxp_iot_Argument_init_zero, nxp_iot_Argument_init_zero, nxp_iot_Argument_init_zero,    \
