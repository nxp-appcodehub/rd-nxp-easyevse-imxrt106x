...
#define _nxp_iot_HostControlCmdRequest_eControlCmd_ARRAYSIZE \
    ((nxp_iot_HostControlCmdRequest_eControlCmd)(nxp_iot_HostControlCmdRequest_eControlCmd_RESET_SE + 1))
...
#define nxp_iot_HostControlCmdRequest_init_default            \
    {                                                         \
        false, _nxp_iot_HostControlCmdRequest_eControlCmd_MIN \
    }
#define nxp_iot_HostControlCmdRequest_init_zero               \
    {                                                         \
        false, _nxp_iot_HostControlCmdRequest_eControlCmd_MIN \
    }
