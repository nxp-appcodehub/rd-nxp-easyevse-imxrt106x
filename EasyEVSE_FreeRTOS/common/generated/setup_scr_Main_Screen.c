...
void setup_scr_Main_Screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->Main_Screen_img_1, &_mainpng_alpha_194x186);
    lv_img_set_pivot(ui->Main_Screen_img_1, 50,50);
    lv_img_set_angle(ui->Main_Screen_img_1, 0);
    lv_obj_set_pos(ui->Main_Screen_img_1, 147, 58);
    lv_obj_set_size(ui->Main_Screen_img_1, 194, 186);
    ...
    lv_imgbtn_set_src(ui->Main_Screen_ID_EV_btn, LV_IMGBTN_STATE_RELEASED, NULL, &_evse_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_EV_btn, LV_IMGBTN_STATE_PRESSED, NULL, &_evse_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_EV_btn, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_evse_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_EV_btn, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_evse_60x61, NULL);
    ...
    lv_obj_set_pos(ui->Main_Screen_ID_EV_btn, 123, 178);
    ...
    lv_obj_set_style_radius(ui->Main_Screen_ID_EV_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Main_Screen_ID_EV_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_EV_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_EV_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_EV_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
    ...
    lv_imgbtn_set_src(ui->Main_Screen_ID_debug_conn_btn, LV_IMGBTN_STATE_RELEASED, NULL, &_debug_66x58, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_debug_conn_btn, LV_IMGBTN_STATE_PRESSED, NULL, &_debug_66x58, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_debug_conn_btn, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_debug_66x58, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_debug_conn_btn, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_debug_66x58, NULL);
    ...
    lv_obj_set_pos(ui->Main_Screen_ID_debug_conn_btn, 21, 79);
    lv_obj_set_size(ui->Main_Screen_ID_debug_conn_btn, 66, 58);
    ...
    lv_obj_set_style_radius(ui->Main_Screen_ID_debug_conn_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Main_Screen_ID_debug_conn_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_debug_conn_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_debug_conn_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_debug_conn_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
    ...
    lv_imgbtn_set_src(ui->Main_Screen_ID_car_btn, LV_IMGBTN_STATE_RELEASED, NULL, &_carpng_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_car_btn, LV_IMGBTN_STATE_PRESSED, NULL, &_carpng_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_car_btn, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_carpng_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_car_btn, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_carpng_60x61, NULL);
    ...
    lv_obj_set_style_radius(ui->Main_Screen_ID_car_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Main_Screen_ID_car_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_car_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_car_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_car_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
    ...
    lv_imgbtn_set_src(ui->Main_Screen_ID_meter_btn, LV_IMGBTN_STATE_RELEASED, NULL, &_meterguage_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_meter_btn, LV_IMGBTN_STATE_PRESSED, NULL, &_meterguage_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_meter_btn, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_meterguage_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_meter_btn, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_meterguage_60x61, NULL);
    ...
    lv_obj_set_pos(ui->Main_Screen_ID_meter_btn, 307, 61);
    ...
    lv_obj_set_style_radius(ui->Main_Screen_ID_meter_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Main_Screen_ID_meter_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_meter_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_meter_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_meter_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
    ...
    lv_imgbtn_set_src(ui->Main_Screen_ID_NFC_btn, LV_IMGBTN_STATE_RELEASED, NULL, &_nfc_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_NFC_btn, LV_IMGBTN_STATE_PRESSED, NULL, &_nfc_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_NFC_btn, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_nfc_60x61, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_NFC_btn, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_nfc_60x61, NULL);
    ...
    lv_obj_set_pos(ui->Main_Screen_ID_NFC_btn, 307, 178);
    ...
    lv_obj_set_style_radius(ui->Main_Screen_ID_NFC_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Main_Screen_ID_NFC_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_NFC_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_NFC_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_NFC_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
    ...
    lv_imgbtn_set_src(ui->Main_Screen_ID_debug_ISO_btn, LV_IMGBTN_STATE_RELEASED, NULL, &_debug_ISO15118_62x62, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_debug_ISO_btn, LV_IMGBTN_STATE_PRESSED, NULL, &_debug_ISO15118_62x62, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_debug_ISO_btn, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_debug_ISO15118_62x62, NULL);
    lv_imgbtn_set_src(ui->Main_Screen_ID_debug_ISO_btn, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_debug_ISO15118_62x62, NULL);
    ...
    lv_obj_set_style_radius(ui->Main_Screen_ID_debug_ISO_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Main_Screen_ID_debug_ISO_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_debug_ISO_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_debug_ISO_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Main_Screen_ID_debug_ISO_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
