...
void setup_scr_Debug_ISO_Screen(lv_ui *ui)
{
    ...
    lv_imgbtn_set_src(ui->Debug_ISO_Screen_ID_back_btn, LV_IMGBTN_STATE_RELEASED, NULL, &_returnpng_32x28, NULL);
    lv_imgbtn_set_src(ui->Debug_ISO_Screen_ID_back_btn, LV_IMGBTN_STATE_PRESSED, NULL, &_returnpng_32x28, NULL);
    lv_imgbtn_set_src(ui->Debug_ISO_Screen_ID_back_btn, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_returnpng_32x28, NULL);
    lv_imgbtn_set_src(ui->Debug_ISO_Screen_ID_back_btn, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_returnpng_32x28, NULL);
    ...
    lv_obj_set_style_radius(ui->Debug_ISO_Screen_ID_back_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Debug_ISO_Screen_ID_back_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Debug_ISO_Screen_ID_back_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Debug_ISO_Screen_ID_back_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->Debug_ISO_Screen_ID_back_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
