...
void setup_scr_NFC_Screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_radius(ui->NFC_Screen_read_UID_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->NFC_Screen_read_UID_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->NFC_Screen_read_UID_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->NFC_Screen_read_UID_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->NFC_Screen_read_UID_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
    ...
    lv_obj_set_style_radius(ui->NFC_Screen_ID_back_btn, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->NFC_Screen_ID_back_btn, true, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_img_recolor_opa(ui->NFC_Screen_ID_back_btn, 0, LV_PART_MAIN|LV_STATE_PRESSED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->NFC_Screen_ID_back_btn, 0, LV_PART_MAIN|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_img_recolor_opa(ui->NFC_Screen_ID_back_btn, 0, LV_PART_MAIN|LV_IMGBTN_STATE_RELEASED);
